...
\item Frenkel and Smit~\cite{Frenkel:2001:} and Geissler
\item Tuckermann
\end{itemize}
...
convergence, which is covered in a separate Best Practices document (\url{https://github.com/dmzuckerman/Sampling-Uncertainty}). 

...
For more than three bodies and no constraints, there is no analytical solution to the equations of motion.
...
Algorithms to perform this integration take many forms and are what we call integrators.
...
Integrators that minimize discretization error should exhibit preservation of both phase space volume, as well as energy.
...
The later is generally preferred, though it may necessitate other sacrifices such as greater energy fluctuations away from the desired, exact system energy.
...
Additionally, it is also desirable that an integrator be efficient, costing little computationally.
...
As a brief aside, this highlights the fact that integrators are tightly coupled to the chosen thermostat or barostat.

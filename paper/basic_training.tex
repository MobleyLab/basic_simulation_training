...
Luckily, this issue may be avoided simply by guaranteeing that the integrator is reversible.
The reason for this outlined in greater detail in \todo[inline, color={green!20}]{JIM: Add citation to Frenkel and Smit book, and maybe Tuckerman paper from 1992}, but the basic idea is that the mathematical operator associated with an integrator must be unitary in order for phase space volume to be preserved.
...
Detailed discussion and derivation of such integrators may be found in Leach and Frenkel and Smit.

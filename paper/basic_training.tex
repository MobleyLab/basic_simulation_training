...
\todo[inline, color={yellow!20}]{DLM: We will need to police the document as there are a lot of copy-and-paste errors resulting from curly quotes, such as around ``trajectory'' in the preceding paragraph. They currently seem to appear OK in the PDF, but in the LaTeX source they are clearly incorrect.}
